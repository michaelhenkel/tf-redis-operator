...
import (
	...
	redisv1alpha1 "github.com/michaelhenkel/tf-redis-operator/pkg/apis/redis/v1alpha1"
...
func (r *ReconcileRedis) deploymentForRedis(m *redisv1alpha1.Redis) *appsv1.Deployment {
	...
	redisImage := fmt.Sprintf("%s/contrail-external-redis:%s", m.Spec.Registry, m.Spec.Version)
